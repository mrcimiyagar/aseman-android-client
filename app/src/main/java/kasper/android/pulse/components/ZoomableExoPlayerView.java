    ...
    public ZoomableExoPlayerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (attrs != null) {
            TypedArray a = context.getTheme().obtainStyledAttributes(attrs,
                    com.google.android.exoplayer2.R.styleable.PlayerView, 0, 0);
            try {
                playerLayoutId = a.getResourceId(com.google.android.exoplayer2.R.styleable.PlayerView_player_layout_id,
                        playerLayoutId);
                useArtwork = a.getBoolean(com.google.android.exoplayer2.R.styleable.PlayerView_use_artwork, useArtwork);
                defaultArtworkId = a.getResourceId(com.google.android.exoplayer2.R.styleable.PlayerView_default_artwork,
                        defaultArtworkId);
                ...
                controllerShowTimeoutMs = a.getInt(com.google.android.exoplayer2.R.styleable.PlayerView_show_timeout,
...
//        Log.e("aaaaa", String.valueOf(controller.isVisible()));
